...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mpl_animators-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14310&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mpl_animators-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mpl_animators` can be installed with:

```
conda install mpl_animators
```

It is possible to list all of the versions of `mpl_animators` available on your platform with:
